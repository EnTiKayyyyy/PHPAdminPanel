    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr><td>" . $row["E_ID"]. "</td><td>" . $row["Name"]. "</td><td>" . $row["birth"]. "</td><td>" . $row["email"]. "</td><td>" . $row["phone"]. "</td><td>" . $row["gender"]. "</td><td>" . $row["address"]. "</td>";
                echo "<td><button style='margin-right: 10px; border-radius: 10px; background-color: yellow;' onclick=\"location.href='edit_e.php?id=" . $row["E_ID"]. "'\">Sửa</button>";
