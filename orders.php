  ...
  <button class="btn btn-success" onclick="location.href='add_o.php'">Thêm</button>
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            echo "<tr><td>" . $row["O_ID"]. "</td><td>" . $row["E_Name"]. "</td><td>" . $row["R_Name"]. "</td><td>" . $row["S_Name"]. "</td><td>" . $row["status"]. "</td><td>" . $row["Date"]. "</td><td>" . $row["address"]. "</td><td>" . $row["infor"]. "</td>";
            echo "<td><button style='margin-right: 10px; border-radius: 10px; background-color: yellow;' onclick=\"location.href='edit_o.php?id=" . $row["O_ID"]. "'\">Sửa</button><button style='background-color: red;border-radius: 10px;' onclick=\"deleteRecord(" . $row["O_ID"]. ")\">Xóa</button></td></tr>";
